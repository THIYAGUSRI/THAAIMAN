          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
            <div className="bg-white p-8 rounded-xl shadow-2xl max-w-sm w-full">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-4">
                <button onClick={confirmCancel} className="px-6 py-2 text-black hover:text-white rounded-lg hover:bg-red-600 order-1 sm:order-none">
                  Yes, Cancel
                </button>
                <button onClick={closeCancelModal} className="px-6 py-2 border font-semibold border-gray-300 bg-green-500 text-white rounded-lg hover:bg-green-600 order-2 sm:order-none">
                  No, Keep Order
                </button>
              </div>
            </div>
